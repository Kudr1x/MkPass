...
fun LoginScreen(navController: NavController){
    ...
    if(settingsState.value.masterPasswordHash == ""){
        Column(
            modifier = Modifier
                .fillMaxSize(),
            ...
            Column {
                OutlinedTextField(
                    ...
                    isError = loginViewModel.isErrorTextField1,
                    supportingText = {
                        if(loginViewModel.isErrorTextField1) {
                            Text(
                                text = "Minimum master password length 8 characters"
                            )
                        }
                    },
                ...
                OutlinedTextField(
                    ...
                    keyboardActions = KeyboardActions(onDone = {focusManager.clearFocus()}),
                    isError = loginViewModel.isErrorTextField2,
                    supportingText = {
                        if(loginViewModel.isErrorTextField2) {
                            Text(
            ...
            Button(
                ...
                onClick = {
                    coroutine.launch {
                        loginViewModel.checkPasswords(navController, context)
                    }
                }
            ){
                Text(text = "Next")
        ...
        loginViewModel.startOnManger(navController)
    }
}
